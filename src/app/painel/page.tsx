...
export default function PainelPage() {
  ...
  async function carregar(cpfAdmin: string, f: Filtros) {
    setCarregando(true);
  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: 24 }}>
      <h1 style={{ color: "#1B4FA2", fontSize: 26, marginBottom: 16 }}>Painel de Registros</h1>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 16, alignItems: "center" }}>
        ...
        <button
          ...
          onClick={() => carregar(cpfAutorizado, filtros)}
        >
          Filtrar
        </button>
        <button
          ...
          onClick={() => {
            ...
            carregar(cpfAutorizado, FILTROS_VAZIOS);
          }}
        >
          Limpar
        </button>
